...
- Make work rollups / standups identity-grounded across Slack, GitHub, Linear, and local git before trusting automation
- Decide the durable Slack path that best matches the user-auth/private-analyst goal
